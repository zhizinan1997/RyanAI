...
!(function (e, r) {
	'object' == typeof exports && 'undefined' != typeof module
		...
		: 'function' == typeof define && define.amd
			? define(r)
			: ((e = 'undefined' != typeof globalThis ? globalThis : e || self).markdownit = r());
})(this, function () {
	'use strict';
	function e(e) {
		...
		return (
			...
			(t = (function (e) {
				var r,
					...
					n = i[e];
				if (n) return n;
				for (n = i[e] = [], r = 0; r < 128; r++) ((t = String.fromCharCode(r)), n.push(t));
	...
	((l.prototype.parse = function (e, r) {
		...
		if (
			...
			(r || l || a.match(/^\/\/[^@\/]+@[^@\/]+/)) &&
				(!(i = '//' === a.substr(0, 2)) || (l && b[l]) || ((a = a.substr(2)), (this.slashes = !0))),
			!b[l] && (i || (l && !v[l])))
		) {
			var p,
				f,
			...
			var C = a.slice(0, d);
			((a = a.slice(d)), this.parseHost(C), (this.hostname = this.hostname || ''));
		...
		(l.prototype.parseHost = function (e) {
			var r = p.exec(e);
			(r &&
				(':' !== (r = r[0]) && (this.port = r.substr(1)), (e = e.substr(0, e.length - r.length))),
				e && (this.hostname = e));
		}));
	var C = {
			encode: o,
			...
			((n.lib = {}),
				...
				(n.normalizeReference = function (e) {
					return (
						...
						'\u1e7e' === '\u1e9e'.toLowerCase() && (e = e.replace(/\u1e9e/g, '\xdf')),
		...
		S = function (e, r, t) {
			...
			if (60 === e.charCodeAt(r)) {
				for (r++; r < t; ) {
					...
					if (60 === n) return i;
					if (62 === n) return ((i.pos = r + 1), (i.str = E(e.slice(o + 1, r))), (i.ok = !0), i);
					92 === n && r + 1 < t ? (r += 2) : r++;
				}
				return i;
			}
			...
			return (
				o === r || 0 !== s || ((i.str = E(e.slice(o, r))), (i.lines = 0), (i.pos = r), (i.ok = !0)),
				i
			);
		},
		F = function (e, r, t) {
			...
			for (r++, 40 === s && (s = 41); r < t; ) {
				if ((n = e.charCodeAt(r)) === s)
					return ((a.pos = r + 1), (a.lines = o), (a.str = q(e.slice(i + 1, r))), (a.ok = !0), a);
	...
	((M.code_inline = function (e, r, t, n, s) {
		...
		(M.fence = function (e, r, t, n, s) {
			...
			return (
				...
				0 === (o = (t.highlight && t.highlight(u.content, h, f)) || I(u.content)).indexOf('<pre')
					? o + '\n'
					: p
						? ((i = u.attrIndex('class')),
							...
							if ('inline' === b[t].type && e.md.linkify.pretest(b[t].content))
								for (f = 0, r = (s = b[t].children).length - 1; r >= 0; r--)
									if ('link_close' !== (i = s[r]).type) {
										if (
											('html_inline' === i.type &&
												((k = i.content), /^<a[>\s]/i.test(k) && f > 0 && f--, V(i.content) && f++),
	...
	((qe.prototype.push = function (e, r, t) {
		...
		(qe.prototype.skipSpaces = function (e) {
			for (var r, t = this.src.length; e < t && ((r = this.src.charCodeAt(e)), Ee(r)); e++);
			return e;
		}),
		...
		Fe = [
			[
				...
				function (e, r, t, n) {
					...
					if (124 !== (C = e.src.charCodeAt(i++)) && 45 !== C && 58 !== C && !pe(C)) return !1;
					if (45 === v && pe(C)) return !1;
					for (; i < e.eMarks[l]; ) {
						if (124 !== (s = e.src.charCodeAt(i)) && 45 !== s && 58 !== s && !pe(s)) return !1;
						i++;
					}
					for (u = (o = he(e, r + 1)).split('|'), f = [], a = 0; a < u.length; a++) {
						if (!(d = u[a].trim())) {
							...
							for (
								a = h = e.sCount[p] + 1,
									32 === e.src.charCodeAt(D)
										...
										: 9 === e.src.charCodeAt(D)
											? ((b = !0),
												(e.bsCount[p] + h) % 4 == 3 ? (D++, a++, h++, (s = !1)) : (s = !0))
											: (b = !1),
									f.push(e.bMarks[p]),
									e.bMarks[p] = D;
								D < w && ((o = e.src.charCodeAt(D)), de(o));
			...
			[
				...
				function (e, r, t, n) {
					...
					if (C < y && 10 !== g.charCodeAt(C) && b)
						for (b = '', C = o, v = i; C < y && ((s = g.charCodeAt(C)), ve(s)); ) C++;
					return (
			...
			[
				...
				function (e, r, t, n) {
					...
					for (a = e.src.slice(c, l), s = 0; s < De.length && !De[s][0].test(a); s++);
				...
				function (e, r, t, n) {
					...
					return (
						...
						(n ||
							...
							(i = e.skipCharsBack(l, 35, c)) > c && we(e.src.charCodeAt(i - 1)) && (l = i),
							(e.line = r + 1),
	...
	var Pe = {
		tokenize: function (e, r) {
			...
			if (r) return !1;
			if (126 !== a) return !1;
			if (((s = (n = e.scanDelims(e.pos, !0)).length), (o = String.fromCharCode(a)), s < 2))
				return !1;
			...
			[
				...
				function (e, r) {
					...
					if ((a = o + 1) < f && 40 === e.src.charCodeAt(a)) {
						for (m = !1, a++; a < f && ((n = e.src.charCodeAt(a)), Ze(n) || 10 === n); a++);
						if (a >= f) return !1;
			...
			[
				...
				function (e, r) {
					...
					if ((c = i + 1) < _ && 40 === e.src.charCodeAt(c)) {
						for (c++; c < _ && ((n = e.src.charCodeAt(c)), Ge(n) || 10 === n); c++);
						if (c >= _) return !1;
						for (
							d = c,
								...
								t ||
									((n =
										'x' === s[1][0].toLowerCase()
											...
											: parseInt(s[1], 10)),
									((o = e.push('text_special', '', 0)).content = Ke(n) ? Qe(n) : Qe(65533)),
									(o.markup = s[0]),
									(o.info = 'entity')),
								(e.pos += s[0].length),
								!0
	...
	function lr() {
		var e;
		for (this.ruler = new O(), e = 0; e < ar.length; e++) this.ruler.push(ar[e][0], ar[e][1]);
		for (this.ruler2 = new O(), e = 0; e < cr.length; e++) this.ruler2.push(cr[e][0], cr[e][1]);
	}
	...
	((Cr.prototype.add = function (e, r) {
		...
		(Cr.prototype.match = function (e) {
			...
			for (var n = r ? e.slice(r) : e; this.test(n); )
				(t.push(vr(this, r)), (n = n.slice(this.__last_index__)), (r += this.__last_index__));
			...
			return (
				...
				r
					? ((this.__tlds__ = this.__tlds__
						...
						kr(this),
						this)
					: ((this.__tlds__ = e.slice()), (this.__tlds_replaced__ = !0), kr(this), this)
			);
		}),
	...
	function Mr(e) {
		return zr(e, function (e) {
			var r = '';
			return (
				e > 65535 && ((r += Fr((((e -= 65536) >>> 10) & 1023) | 55296)), (e = 56320 | (1023 & e))),
				(r += Fr(e))
			);
		}).join('');
	}
	...
	function Br(e, r, t) {
		var n = 0;
		for (e = t ? Sr(e / 700) : e >> 1, e += Sr(e / r); e > 455; n += xr) e = Sr(e / 35);
	...
	function Or(e) {
		...
		for (n = s = g.length, s && g.push('-'); n < h; ) {
			...
			for (
				a - r > Sr((Ar - t) / (f = n + 1)) && Lr('overflow'), t += (a - r) * f, r = a, i = 0;
				i < h;
				++i
			)
				if (((p = e[i]) < r && ++t > Ar && Lr('overflow'), p == r)) {
					for (c = t, l = xr; !(c < (u = l <= o ? 1 : l >= o + 26 ? 26 : l - o)); l += xr)
						((m = c - u), (d = xr - u), g.push(Fr(Rr(u + (m % d), 0))), (c = Sr(m / d)));
	...
	var Ur = '1.4.1',
		...
		Zr = { version: Ur, ucs2: Vr, toASCII: jr, toUnicode: Pr, encode: Or, decode: Nr },
		$r = e(
			Object.freeze({
				__proto__: null,
				decode: Nr,
