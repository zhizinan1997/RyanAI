	...
	var e = (() => {
		...
		function o(o) {
			const l = o.regex,
				...
				p = {
					...
					starts: { end: '`', returnEnd: !1, contains: [o.BACKSLASH_ESCAPE, A], subLanguage: 'xml' }
				},
				N = {
					begin: 'css`',
					end: '',
					starts: { end: '`', returnEnd: !1, contains: [o.BACKSLASH_ESCAPE, A], subLanguage: 'css' }
				},
				f = {
					begin: 'gql`',
					end: '',
			...
			const v = [].concat(h, A.contains),
				w = v.concat([{ begin: /\(/, end: /\)/, keywords: g, contains: ['self'].concat(v) }]),
				R = {
					className: 'params',
					begin: /\(/,
					end: /\)/,
			...
			return {
				...
				contains: [
					...
					},
					{
						...
						returnBegin: !0,
						label: 'func.def',
						contains: [R, o.inherit(o.TITLE_MODE, { begin: d, className: 'title.function' })]
					},
					{ match: /\.\.\./, relevance: 0 },
					T,
					{ match: '\\$' + d, relevance: 0 },
		...
		return (t) => {
			...
			return (
				...
				m(s, 'use_strict', { className: 'meta', relevance: 10, begin: /^\s*['"]use strict['"]/ }),
