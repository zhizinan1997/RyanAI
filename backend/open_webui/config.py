...
CUSTOM_BRANDING_NAME = CUSTOM_NAME or ORGANIZATION_NAME or 'RyanAI'

_CUSTOM_STATIC_ASSETS = (
    (CUSTOM_ICO, ('favicon.ico',)),
    (
        CUSTOM_PNG,
        (
            'favicon.png',
    ...
    (CUSTOM_DARK_PNG, ('favicon-dark.png', 'splash-dark.png')),
    (CUSTOM_SVG, ('favicon.svg',)),
)
...
if DISABLE_LOCAL_EMBEDDING_MODELS and RAG_EMBEDDING_ENGINE == '':
    log.info(
        'Local embedding models are disabled; forcing RAG_EMBEDDING_ENGINE to openai '
        'to avoid Hugging Face model downloads.'
    )
    RAG_EMBEDDING_ENGINE = 'openai'
    if not RAG_EMBEDDING_MODEL or RAG_EMBEDDING_MODEL.startswith('sentence-transformers/'):
        RAG_EMBEDDING_MODEL = os.getenv('RAG_EMBEDDING_MODEL', 'text-embedding-3-small')
...
ENABLE_SIGNUP_VERIFY = os.getenv('ENABLE_SIGNUP_VERIFY', 'False').lower() == 'true'
...
SMTP_SENT_FROM = os.getenv('SMTP_SENT_FROM', '')

ENABLE_AI_ERROR_EMAIL_NOTIFICATION = os.getenv('ENABLE_AI_ERROR_EMAIL_NOTIFICATION', 'False').lower() == 'true'
...
ENABLE_SPLASH_NOTICE = os.getenv('ENABLE_SPLASH_NOTICE', 'False').lower() == 'true'

SPLASH_NOTICE_TITLE = os.getenv('SPLASH_NOTICE_TITLE', '')

SPLASH_NOTICE_CONTENT = os.getenv('SPLASH_NOTICE_CONTENT', '')

SPLASH_NOTICE_MEDIA = os.getenv('SPLASH_NOTICE_MEDIA', '')
...
USAGE_DEFAULT_ENCODING_MODEL = os.getenv('USAGE_DEFAULT_ENCODING_MODEL', 'gpt-4o')

USAGE_CALCULATE_DEFAULT_REQUEST_PRICE = os.getenv('USAGE_CALCULATE_DEFAULT_REQUEST_PRICE', '0')

USAGE_CALCULATE_DEFAULT_TOKEN_PRICE = os.getenv('USAGE_CALCULATE_DEFAULT_TOKEN_PRICE', '0')

USAGE_CALCULATE_DEFAULT_EMBEDDING_PRICE = os.getenv('USAGE_CALCULATE_DEFAULT_EMBEDDING_PRICE', '0')

USAGE_CALCULATE_FEATURE_IMAGE_GEN_PRICE = os.getenv('USAGE_CALCULATE_FEATURE_IMAGE_GEN_PRICE', '0')

USAGE_CALCULATE_FEATURE_CODE_EXECUTE_PRICE = os.getenv('USAGE_CALCULATE_FEATURE_CODE_EXECUTE_PRICE', '0')

USAGE_CALCULATE_FEATURE_WEB_SEARCH_PRICE = os.getenv('USAGE_CALCULATE_FEATURE_WEB_SEARCH_PRICE', '0')

USAGE_CALCULATE_FEATURE_TOOL_SERVER_PRICE = os.getenv('USAGE_CALCULATE_FEATURE_TOOL_SERVER_PRICE', '0')

USAGE_CALCULATE_MINIMUM_COST = os.getenv('USAGE_CALCULATE_MINIMUM_COST', '0')
...
DEFAULT_CONFIG = {
    ...
    'ui.smtp.password': SMTP_PASSWORD,
    ...
    'ui.splash_notice_enabled': ENABLE_SPLASH_NOTICE,
    'ui.splash_notice_title': SPLASH_NOTICE_TITLE,
    'ui.splash_notice_content': SPLASH_NOTICE_CONTENT,
    'ui.splash_notice_media': SPLASH_NOTICE_MEDIA,
    ...
    'credit.calculate.default_token_price': USAGE_CALCULATE_DEFAULT_TOKEN_PRICE,
    'credit.calculate.default_embedding_price': USAGE_CALCULATE_DEFAULT_EMBEDDING_PRICE,
    'credit.calculate.feature.image_gen_price': USAGE_CALCULATE_FEATURE_IMAGE_GEN_PRICE,
    'credit.calculate.feature.code_execute_price': USAGE_CALCULATE_FEATURE_CODE_EXECUTE_PRICE,
    'credit.calculate.feature.web_search_price': USAGE_CALCULATE_FEATURE_WEB_SEARCH_PRICE,
