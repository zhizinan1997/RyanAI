                        ...
                        await event_emitter(
                            {
                                ...
                                'data': {'error': error_payload, 'done': True},
                            }
                        )
        ...
        **(
            {
                ...
                **({'user_count': user_count} if user_count is not None else {}),
                ...
                'ui': {
                    ...
                    'splash_notice_enabled': config.get('ui.splash_notice_enabled'),
                    'splash_notice_title': config.get('ui.splash_notice_title'),
                    'splash_notice_content': config.get('ui.splash_notice_content'),
                    'splash_notice_media_url': (
                        f"/api/v1/auths/admin/config/splash-notice/media/{urllib.parse.quote(config.get('ui.splash_notice_media'))}"
                        if config.get('ui.splash_notice_media')
                        else ''
                    ),
