				...
				{:else}
					...
					>
						...
						>
							...
							<div class="px-2.5">
								<div
									class="scrollbar-none rtl:text-right ltr:text-left bg-transparent dark:text-gray-100 outline-hidden w-full pt-2.5 pb-[5px] px-1 resize-none h-fit max-h-96 overflow-auto"
								>
