<script>
	...
	import SplashNotice from './Settings/SplashNotice.svelte';
	...
	const allSettings = [
		...
		},
		{
			id: 'splash-notice',
			title: 'Splash Notice',
			route: '/admin/settings/splash-notice',
			keywords: [
				'splash',
				'notice',
				'popup',
...
<div class="flex flex-col lg:flex-row w-full h-full pb-2 lg:space-x-4">
				...
				<div class=" self-center mr-2">
					...
					{:else if tab.id === 'splash-notice'}
						...
						>
							<path
								fill-rule="evenodd"
								d="M8 1.5a3.25 3.25 0 0 0-3.25 3.25v.46c0 .91-.343 1.787-.961 2.457l-.24.26A1.5 1.5 0 0 0 4.651 10.5h6.698a1.5 1.5 0 0 0 1.102-2.533l-.24-.26a3.64 3.64 0 0 1-.961-2.457v-.46A3.25 3.25 0 0 0 8 1.5ZM6 11.25a2 2 0 1 0 4 0H6Z"
								clip-rule="evenodd"
							/>
						</svg>
	...
	>
		{#if selectedTab === 'general'}
			...
			/>
		{:else if selectedTab === 'splash-notice'}
			<SplashNotice
				saveHandler={async () => {
					toast.success($i18n.t('Settings saved successfully!'));
