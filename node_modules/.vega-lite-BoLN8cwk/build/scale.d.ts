import type { ColorScheme, RangeEnum, ScaleBins, ScaleInterpolateEnum, ScaleInterpolateParams, SignalRef, TimeInterval, TimeIntervalStep } from 'vega';
...
export declare const NON_TYPE_DOMAIN_RANGE_VEGA_SCALE_PROPERTIES: ("domainMin" | "domainMax" | "domainMid" | "domainRaw" | "reverse" | "round" | "nice" | "zero" | "bins" | "interpolate" | "clamp" | "padding" | "base" | "constant" | "exponent" | "paddingInner" | "paddingOuter" | "align")[];
