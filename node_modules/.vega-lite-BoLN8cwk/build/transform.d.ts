...
export declare function isLookupData(from: LookupData | LookupSelection): from is LookupData;
export declare function isLookupSelection(from: LookupData | LookupSelection): from is LookupSelection;
...
export declare function isPivot(t: Transform): t is PivotTransform;
...
export declare function isDensity(t: Transform): t is DensityTransform;
...
export declare function isQuantile(t: Transform): t is QuantileTransform;
...
export declare function isRegression(t: Transform): t is RegressionTransform;
...
export declare function isLoess(t: Transform): t is LoessTransform;
...
export declare function isJoinAggregate(t: Transform): t is JoinAggregateTransform;
...
export declare function isExtent(t: Transform): t is ExtentTransform;
export type Transform = AggregateTransform | BinTransform | CalculateTransform | DensityTransform | ExtentTransform | FilterTransform | FlattenTransform | FoldTransform | ImputeTransform | JoinAggregateTransform | LoessTransform | LookupTransform | QuantileTransform | RegressionTransform | TimeUnitTransform | SampleTransform | StackTransform | WindowTransform | PivotTransform;
export declare function normalizeTransform(transform: Transform[]): (AggregateTransform | BinTransform | CalculateTransform | DensityTransform | ExtentTransform | FlattenTransform | FoldTransform | ImputeTransform | JoinAggregateTransform | LoessTransform | LookupTransform | QuantileTransform | RegressionTransform | TimeUnitTransform | SampleTransform | StackTransform | WindowTransform | PivotTransform | {
    filter: LogicalComposition<Predicate>;
})[];
