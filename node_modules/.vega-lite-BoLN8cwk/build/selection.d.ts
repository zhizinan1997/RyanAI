...
export interface SelectionParameter<T extends SelectionType = SelectionType> {
     ...
     */
    value?: T extends 'point' ? SelectionInit | SelectionInitMapping[] : T extends 'interval' ? SelectionInitIntervalMapping : never;
    /**
     ...
     */
    bind?: T extends 'point' ? Binding | Record<string, Binding> | LegendBinding : T extends 'interval' ? 'scales' : never;
}
...
export declare function isSelectionParameter(param: any): param is SelectionParameter;
